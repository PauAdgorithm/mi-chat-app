    ...
    try {
        ...
        const runner = await openai.chat.completions.create({
            ...
            tools: [
                ...
                { type: "function", function: { name: "book_appointment", description: "Reservar cita.", parameters: { type: "object", properties: { appointmentId: { type: "string" } }, required: ["appointmentId"] } } },
                { type: "function", function: { name: "assign_department", description: "Asignar depto.", parameters: { type: "object", properties: { department: { type: "string", enum: ["Ventas", "Taller", "Admin"] } }, required: ["department"] } } },
...
app.put('/api/appointments/:id', async (req, res) => {
    ...
    try {
        ...
        // Permitimos vaciar el teléfono/nombre si se pasa string vacío
